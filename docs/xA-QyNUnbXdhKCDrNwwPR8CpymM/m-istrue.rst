...
.. <% set key = ".fld-Assert.FB_Assert.M_IsTRUE" %>
.. _`.fld-Assert.FB_Assert.M_IsTRUE`:
.. <% merge "object.Defines" %>
.. <% endmerge  %>


.. _`FB_Assert.M_IsTRUE`:

FB_Assert.M_IsTRUE (METH)
-------------------------
...
.. todo:: Please add documentation for method: FB_Assert.M_IsTRUE
