...
.. <% set key = ".fld-Assert.I_Assert.M_Equals_STRING" %>
.. _`.fld-Assert.I_Assert.M_Equals_STRING`:
.. <% merge "object.Defines" %>
.. <% endmerge  %>


.. _`I_Assert.M_Equals_STRING`:

I_Assert.M_Equals_STRING (METH)
-------------------------------
...
.. todo:: Please add documentation for method: I_Assert.M_Equals_STRING
