...
.. <% set key = ".fld-Assert.I_Assert.M_Equals_INT" %>
.. _`.fld-Assert.I_Assert.M_Equals_INT`:
.. <% merge "object.Defines" %>
.. <% endmerge  %>


.. _`I_Assert.M_Equals_INT`:

I_Assert.M_Equals_INT (METH)
----------------------------
...
.. todo:: Please add documentation for method: I_Assert.M_Equals_INT
