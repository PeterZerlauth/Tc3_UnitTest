...
.. <% set key = ".fld-Assert.FB_Assert.M_Equals_DINT" %>
.. _`.fld-Assert.FB_Assert.M_Equals_DINT`:
.. <% merge "object.Defines" %>
.. <% endmerge  %>


.. _`FB_Assert.M_Equals_DINT`:

FB_Assert.M_Equals_DINT (METH)
------------------------------
...
.. todo:: Please add documentation for method: FB_Assert.M_Equals_DINT
