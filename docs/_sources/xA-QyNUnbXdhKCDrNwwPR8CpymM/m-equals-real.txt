...
.. <% set key = ".fld-Assert.FB_Assert.M_Equals_REAL" %>
.. _`.fld-Assert.FB_Assert.M_Equals_REAL`:
.. <% merge "object.Defines" %>
.. <% endmerge  %>


.. _`FB_Assert.M_Equals_REAL`:

FB_Assert.M_Equals_REAL (METH)
------------------------------
...
.. todo:: Please add documentation for method: FB_Assert.M_Equals_REAL
