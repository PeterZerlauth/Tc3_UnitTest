...
.. <% set key = ".fld-Assert.I_Assert.M_Equals_Array_LREAL" %>
.. _`.fld-Assert.I_Assert.M_Equals_Array_LREAL`:
.. <% merge "object.Defines" %>
.. <% endmerge  %>


.. _`I_Assert.M_Equals_Array_LREAL`:

I_Assert.M_Equals_Array_LREAL (METH)
------------------------------------
...
.. todo:: Please add documentation for method: I_Assert.M_Equals_Array_LREAL
