...
.. <% set key = ".fld-Assert.I_Assert.M_Equals_Array_INT" %>
.. _`.fld-Assert.I_Assert.M_Equals_Array_INT`:
.. <% merge "object.Defines" %>
.. <% endmerge  %>


.. _`I_Assert.M_Equals_Array_INT`:

I_Assert.M_Equals_Array_INT (METH)
----------------------------------
...
.. todo:: Please add documentation for method: I_Assert.M_Equals_Array_INT
