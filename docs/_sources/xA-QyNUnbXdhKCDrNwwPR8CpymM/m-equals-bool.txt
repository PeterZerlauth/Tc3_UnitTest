...
.. <% set key = ".fld-Assert.FB_Assert.M_Equals_BOOL" %>
.. _`.fld-Assert.FB_Assert.M_Equals_BOOL`:
.. <% merge "object.Defines" %>
.. <% endmerge  %>


.. _`FB_Assert.M_Equals_BOOL`:

FB_Assert.M_Equals_BOOL (METH)
------------------------------
...
.. todo:: Please add documentation for method: FB_Assert.M_Equals_BOOL
